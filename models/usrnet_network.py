...
class ResUNet(nn.Module):
    def __init__(self, in_nc=4, out_nc=3, nc=[16, 32, 64, 64], nb=2, act_mode='R', downsample_mode='strideconv', upsample_mode='convtranspose'):
...
class HyPaNet(nn.Module):
    def __init__(self, in_nc=2, out_nc=12, channel=32):
...
class USRNet(nn.Module):
    def __init__(self, n_iter=6, h_nc=32, in_nc=4, out_nc=3, nc=[16, 32, 64, 64], nb=2, act_mode='R', downsample_mode='strideconv', upsample_mode='convtranspose'):
...
def define_G(opt):
    ...
    netG = USRNet(n_iter=opt_net['n_iter'],
                h_nc=opt_net['h_nc'],
                in_nc=opt_net['in_nc'],
